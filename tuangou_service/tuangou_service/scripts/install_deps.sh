...
SYS_DEPS=(python-pip python2.7-dev libxml2-dev openjdk-6-jre-headless redis-server libmysqlclient-dev)

PYTHON_DEPS=( "pyDes" "uWSGI" "django==1.4" "pymongo==2.1" "celery" "sqlalchemy" "redis" "requests" "MySQL-python" "django_compressor==1.2" "beautifulsoup4==4.2.1" "libjpeg-dev")  #0.9.6.8, with version ,pip cannot find it
